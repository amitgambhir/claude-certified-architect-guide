...
All domains · Quiz · Traps & Gotchas · Cheat sheet
...
Focus on **trade-offs** — not just what, but why one approach over another. Click any domain to jump to its notes.
...
| 6 | [Agent SDK](domains/agent-sdk.md) | 27% | 5-step loop, max_turns, max_budget_usd, escalation triggers |
| 7 | [Agentic Patterns & Decomposition](domains/agentic-patterns.md) | 27% | chaining, routing, orchestrator-workers, dynamic |
| 8 | [Workflow Design](domains/workflow-design.md) | 27% | escalation logic, enforcement spectrum, compliance, partial resolution |
| 9 | [Prompt Engineering & System Prompts](domains/prompt-engineering.md) | 20% | principles vs conditionals, dilution, few-shot, versioning |
| 10 | [Context Management & Reliability](domains/context-management.md) | 15% | recency bias, compaction, provenance, scratchpad |
